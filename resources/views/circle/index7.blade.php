...
<body>
    <div class=container> @include('partials._nav')
        <header>
            ...
            <h2>Nice hover effects on circles with CSS Transitions (circles are links, click them)</h2>
            <nav class=codrops-demos> <a href=/index>Demo 1</a> <a href=/index2>Demo 2</a> <a href=/index3>Demo 3</a> <a href=/index4>Demo 4</a> <a href=/index5>Demo 5</a> <a href=/index6>Demo 6</a> <a class=current-demo href=/index7>Demo 7</a> </nav>
            <div class=support-note>
                <!-- let's check browser support with modernizr -->
                <!--span class="no-cssanimations">CSS animations are not supported in your browser</span--><span class=no-csstransforms>CSS transforms are not supported in your browser</span> <span class=no-csstransforms3d>CSS 3D transforms are not supported in your browser</span> <span class=no-csstransitions>CSS transitions are not supported in your browser</span> <span class=note-ie>Sorry, only modern browsers.</span> </div>
        </header>
        <section class=main>
            <ul class=ch-grid>
                <li>
                        ...
                        <div class=ch-item>
                            <div class=ch-info>
                                ...
                                <div class=ch-info-back>
                                    <h3>Hover</h3>
                                    <p>Let AccessTech.io Work For You</p>
                                </div>
                            </div>
                        </div>
                    </a>
