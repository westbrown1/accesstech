<head>
    ...
    <title>Web | Circle Hover Effects with CSS Transitions</title>
     ...
     @include('partials._nav')
		...
		<header>
			...
			<nav class="codrops-demos">
				...
				<a class="current-demo" href="/index3">Demo 3</a>
				...
				<li>
					<div class="ch-item">	
						<div class="ch-info">
							...
							<p>pattern by Jonathan Quintin <a href="http://drbl.in/eGjw">View on Dribbble</a></p>
						</div>
				...
				<li>
					<div class="ch-item">
						<div class="ch-info">
							...
							<p>pattern by Jon Gerlach <a href="http://drbl.in/eFWR">View on Dribbble</a></p>
						</div>
				...
				<li>
					<div class="ch-item">
						<div class="ch-info">
							...
							<p>pattern by Kawal Oberoi <a href="http://drbl.in/eFED">View on Dribbble</a></p>
						</div>
