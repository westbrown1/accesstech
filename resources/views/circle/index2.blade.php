...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    ...
    <link rel=stylesheet type=text/css href=css/circle/style2.css>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class=container> @include('partials._nav')
        <header>
            ...
            <nav class=codrops-demos> <a href=/index>Demo 1</a> <a class=current-demo href=/index2>Demo 2</a> <a href=/index3>Demo 3</a> <a href=/index4>Demo 4</a> <a href=/index5>Demo 5</a> <a href=/index6>Demo 6</a> <a href=/index7>Demo 7</a> </nav>
    ...
    <!-- /container -->@include('partials._footer') @include('partials._js')
    <script async type=text/javascript src=js/circle/modernizr.custom.79639.js></script>
</body>