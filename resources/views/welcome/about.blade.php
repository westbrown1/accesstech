...
<div class="row">
	<div class="col-md-10 col-md-offset-1 text-justify well" id="aboutus">
		...
		<hr>
			...
			As for me.  I also enjoy spending time with my 9 year old son.  He likes to surf.  Play basketball.  Tennis.  Golf.  And is one impressive swimmer.  He enjoys his time on beautiful Wrightsville Beach as much as I do.  Please allow me to assist you in your web development needs.  I am happy to help.  You can call/text me at 910-200-1391. <br><br> {{Html::mailto('lawsonsdad@gmail.com', 'Email West')}}<br><a href="/contact">All Contact Info</a><br><a href="/">Home</a>
		</div>
	</div>
</div>
@stop
