...
<section class="pricing-section bg-4">
    <h2 class="pricing-section__title">Let AccessTech.io build you website today.</h2>
...
<div class="row">
	<h3 class="text-center">Just a sample of what we can do.</h3>			
		...
		<center><a href="/">Home</a> | <a href="/contact">Contact Us</a> | <a href="/about">About Us</a></center>
