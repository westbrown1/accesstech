            ...
            <div class="col-md-2">              
              ...
              <div class="col-md-4">
                <div class="wow rotateIn">                
                  <div class="img-thumbnail" class="text-center">
                  <a href="/contact">
                    ...
                    <p class="text-center"><a href="mailto:lawsonsdad@gmail.com" style="color: #333"><i class="fa fa-envelope"></i> Email West</p></a>                                  
                  </div><!-- /img-thumbnail -->               
              </div>
            </div>
