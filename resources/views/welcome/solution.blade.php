...
<div class="row">
	<div class="col-md-10 col-md-offset-1 well" id="solution">
		...
		<ol class="text-justify reasons">
			...
			<li>We like to work smart.  We work with Sublime Text 3 Text Editor and Visual Studio Code.  And use the top plugins including Emmet.  We use custom snippets.  Key bindings.  Macros.  And of course their super autocompletion.  This allows for much quicker coding.  Without losing quality.</li>
