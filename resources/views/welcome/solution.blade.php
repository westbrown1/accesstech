...
<div class="row">
	<div class="col-md-10 col-md-offset-1 well" id="solution">
		...
		<ol class="text-justify reasons">
			<li>Our designs are fully responsive.  They scale great with smart phones.  Tablets.  And any size computer.  NOTE:  We are super with dynamic functionality and animation.</li>
